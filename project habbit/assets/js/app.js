...
function rerenderHead(activeHabbit) {
    ...
    page.header.progressCoverBar.setAttribute('style', `width: ${progress}%; height:5px;`);
}
...
function rerenderContent(activeHabbit) {
    ...
    for(const index in activeHabbit.days){
        ...
        element.innerHTML  = `<div class="habit__day">
        Day ${Number(index) + 1}
    </div>
    ...
    <button class="habit__delete" onclick="deleteDay(${index})">
        <img src="./assets/images/delete.svg" alt="Delete day ${index + 1}">
    </button>`
